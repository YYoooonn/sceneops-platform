...
.PHONY: ros2-up
ros2-up:
	$(COMPOSE) --profile ros2 up -d --build
...
ros2-down:
	$(COMPOSE) --profile ros2 down ros2

.PHONY: ros2-shell
ros2-shell:
	$(COMPOSE) --profile ros2 exec ros2 bash
...
ros2-run:
	...
	$(COMPOSE) --profile ros2 run --rm ros2 sh -c "$(ROS2_CMD)"

.PHONY: ros2-logs
ros2-logs:
	$(COMPOSE) --profile ros2 logs -f ros2

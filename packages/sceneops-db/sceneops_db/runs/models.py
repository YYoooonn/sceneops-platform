...
from sqlalchemy import DateTime, Integer, String, Text, text, Boolean
...
class EvaluationRunModel(Base):
    ...
    inference_run_id: Mapped[str] = mapped_column(String(128), index=True, nullable=False)
    ...
    metrics: Mapped[dict[str, Any]] = mapped_column(JSONB, nullable=False, default=dict)
    class_metrics: Mapped[dict[str, Any]] = mapped_column(JSONB, nullable=False, default=dict)
